...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "metamodel.Presentation": {
            ...
            "properties": {
                "badge": {
                    "description": "Badge asks clients to show an enum field's value as a chip next to the\nentity's name, on its page and in search results.",
                    "type": "boolean"
                },
                "control": {
